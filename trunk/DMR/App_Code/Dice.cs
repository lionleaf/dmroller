...
/// <summary>
/// Currently not in use. Mainly for later executable versions. Class for a single die of any size. 
/// </summary>
public class Dice
{
    ...
    public Dice(int MaxRoll, bool Positive) //For the posibility of negative dice!
    {
        _positive = Positive;
        _maxRoll = MaxRoll;
    }
